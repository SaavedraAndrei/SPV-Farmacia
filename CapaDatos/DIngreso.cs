...
namespace CapaDatos
{
    public class DIngreso
    {
        ...
        {
            DataTable DtResultado = new DataTable("tblDetalle_Ingreso");
            SqlConnection SqlCn = new SqlConnection();
        ...
        public DataTable ConsultarDetalle_Ingreso(string TextoBuscar)
        {
            DataTable DtResultado = new DataTable("tblDetalle_Ingreso");
            SqlConnection SqlCn = new SqlConnection();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = SqlCn;
                cmd.CommandText = "SP_C_TABLA_DETALLE_INGRESO";
                cmd.CommandType = CommandType.StoredProcedure;
